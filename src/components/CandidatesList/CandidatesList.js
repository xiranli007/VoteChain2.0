...
//   { id: "3", name: "Candidate 3" },
// ];
// const CandidatesList = ({ selectedElection, isElectionVoted }) => {
//   const [isVotingDisabled, setVotingDisabled] = useState(false);
//   const [votedCandidate, setVotedCandidate] = useState(null);
//   const [isVoted, setIsVoted] = useState(false);
//   const [confirmation, setConfirmation] = useState(null);
...
//       if (!isVoted) {  // Check if user already voted
//         const dataItem = {
//           electionId,
//           candidateId,
//           voterId: user.uid,
...
//               {confirmation && (
//                 <div className={styles.confirmationReceipt}>
//                   <Typography variant="h5">Vote Confirmation Receipt</Typography>
//                   <Typography variant="body1">
//                     <strong>Transaction ID:</strong> {confirmation.transactionId}
//                   </Typography>
//                   <Typography variant="body1">
